rm(list=ls())
library(forestplot)
data <- read.csv ('data for Figure 2.csv') ###Reading in data for Figure 2
#data <- read.csv ('data for Supplementary Figure 3.csv')  ###Reading in data for Supplementary Figure 3
tabletext<-cbind( 
